...
main (int argc, char **argv)
{
	...
	pmap_unset (ONLINE_STORE, VERSION_1);
	...
	if (!svc_register(transp, ONLINE_STORE, VERSION_1, online_store_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (ONLINE_STORE, VERSION_1, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, ONLINE_STORE, VERSION_1, online_store_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (ONLINE_STORE, VERSION_1, tcp).");
		exit(1);
	}
